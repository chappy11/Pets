...
import {Container,Row,Col,Form,Stack,Image,Button} from 'react-bootstrap';
    ...
    return(
        <> 
            ...
            <SizeBox height={30}/>
                ...
                <p>Pay</p>
                <Form.Check type='radio' label="Pay 50%" name="isHalf" value="1" onChange={onChange}/>
                <Form.Check type='radio' label="Pay amount" name="isHalf" value="0" onChange={onChange}/>
                <SizeBox height={30}/>
