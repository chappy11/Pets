...
export default function AddProduct(){
   ...
   // console.log(data);
    ...
    async function handleAddproduct(){
        ...
        else if(name === "" || description === "" || category_id === "" || unit==="" || price===""){
            ...
            <Sidebar>
                ...
                <Container>
                    <Row>
                        <Col>
                       {img && (
                            <Image width={200} height={200} src={URL.createObjectURL(img)}/>
                       )}
                            <TextInput type='file' onChange={onChangeImage}/>
                        </Col>
                        <Col>
                            <TextInput name="name" onChange={onChange} placeholder="Product Name" label="Product Name"/>
                            <SizeBox height={15}/>
                            <TextInput name="description" onChange={onChange} placeholder="Product Description" label="Product Description"/>
                            <SizeBox height={15}/>
                            ...
                            <Form.Select name="unit" onChange={onChange}>
                                ...
                                {UNIT.map((val,index)=>(
                                    <option key={index.toString()} value={val}>{val}</option>
                                ))}
                            </Form.Select>
                            <SizeBox height={15}/>
                           <TextInput label="Price" name="price" type="number" placeholder="0.00" onChange={onChange}/>
                           <SizeBox height={15}/>
                           <TextInput label="Stock Available" name="stock" type="number" placeholder="0" onChange={onChange}/>
                           <SizeBox height={30}/>
